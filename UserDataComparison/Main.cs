...
namespace UserDataComparison
{
    public partial class Main : Form
    {
        ...
        {
            string insertQuery = "INSERT INTO userdata_tb(name,gender,age,birth, hobby, address, religion, mbti) VALUES('" + textBox_Name.Text + "', '" + label_gender_value.Text + "', '" + textBox_age.Text + "', '" + comboBox_birth_month.Text + "', '" + comboBox_Hobby.Text +"', '" + comboBox_address.Text + "', '" + comboBox_religion.Text + "', '" + comboBox_MBTI.Text + "')";
